...
class Suggestions extends Component {
  ...
  render = () => {
    ...
    return (
        <div ref="suggestionsContainer" className={this.props.classNames.suggestions} style={this.props.styles.suggestions}>
          <ul style={this.props.styles.suggestionsList}> { suggestions } </ul>
        </div>
    )
  }
}
