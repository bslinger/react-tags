...
var ReactTags = React.createClass({
  ...
  render: function() {
    ...
    const tagInput =  !this.props.readOnly ? (
      <div className={this.state.classNames.tagInput} style={this.state.styles.tagInput}>
    ...
    return (
      <div className={this.state.classNames.tags} style={this.state.styles.tags}>
        <div className={this.state.classNames.selected} style={this.state.styles.selected}>
          {tagItems}
